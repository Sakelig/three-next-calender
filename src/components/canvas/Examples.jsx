...
export const Rectangle = ({ imagePath='/The_Wiggsters.jpg', onDoorContentClick, selectedDoor, doorPosition, currentDay, username, initiallyOpenDoors = [0], ...props }) => {
  ...
  const doors = Array.from({ length: 24 }, (_, i) => {
    ...
    const doorContents = {
      ...
      4: { doorNumber: 19, type: 'image', src: '/door-content/snoowman.png', outsideImage: '/door-outside-images/door-4.png' },
      ...
      11: { doorNumber: 21, type: 'video', src: '/door-content/wiggsters-ai-slop.mp4', outsideImage: '/door-outside-images/door-11.png' },
      ...
      15: { doorNumber: 24, type: 'video', src: '/door-content/nightreing24th.mp4', outsideImage: '/door-outside-images/door-15.png' },
      ...
      18: { doorNumber: 23, type: 'image', src: '/door-content/lidl_content.png', outsideImage: '/door-outside-images/door-18.png' },
